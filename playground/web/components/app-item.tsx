    ...
    <div className="flex items-center h-16 space-x-2 p-3 hover:bg-gray-50 rounded-lg transition-all duration-200 border border-transparent hover:border-gray-100">
        ...
        <div className="flex items-center space-x-1 mb-1">
          ...
          <span
            className={`text-xs px-2 py-0.5 rounded-full font-medium border ${
              recording
                ? "bg-red-50 text-red-600 border-red-100 opacity-100"
                : "opacity-0"
            }`}
          >
      ...
      {(isRunning || isRecording) && (
        <button
          ...
          className={`h-8 min-w-20 flex items-center justify-center rounded-lg text-sm font-medium transition-all duration-200 ${
            isRecording
